...
void COutputWnd::setBuildwindowContents(CString s) {
	m_wndOutputBuild.AddString((LPCTSTR)s);
};
void COutputWnd::setDebugdwindowContents(CString s) {
	m_wndOutputBuild.AddString((LPCTSTR)s);
};
void COutputWnd::setFinddwindowContents(CString s) {
	m_wndOutputBuild.AddString((LPCTSTR)s);
};